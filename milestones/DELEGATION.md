...
| ---- | ----------- | --------------------------------------------- | ------------------------------ |
| 1    | Claude Code | `claude -p "<brief>" --permission-mode acceptEdits` (headless) | highest quality, first choice  |
| 2    | Codex       | `codex exec "<brief>"`                        | second choice                  |
| 3    | Antigravity | its CLI / headless mode                       | third choice                   |
