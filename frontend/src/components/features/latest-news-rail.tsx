  ...
  return (
    <IqCard padded={false} className="flex flex-col p-5">
      <div className="flex items-center justify-between">
        <CardEyebrow>Latest News</CardEyebrow>
      ...
      {isLoading ? (
        ...
        <p className="mt-4 text-xs text-muted-foreground">No headlines in the feed right now.</p>
      ) : (
              ...
              <Link to="/news" className="flex gap-3 py-3 transition-colors hover:bg-surface/50">
                ...
                <div className="min-w-0 flex-1">
                  ...
                  <p className="mt-0.5 text-[11px] text-muted-foreground">
                    ...
                    · {n.source}
                    {n.impact === "high" && (
                      <span className="ml-1 font-semibold text-bearish">· high impact</span>
                    )}
                  </p>
                </div>
              </Link>
