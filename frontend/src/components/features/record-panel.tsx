...
/**
 * The forward-test record: engine auto-tracked calls + the viewer's own
 * followed signals. Lives at `/tracker` and as the "Record" tab inside
 * `/markets` (IA-REDESIGN-2026-07-23 §4.5) — both render this same panel.
 */
